            ...
            {simulations.map((sim, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Left Spacer (For even items, push content right; for odd, place left) */}
                  ...
                  >
                    ...
                    {/* PC Duration Indicator on opposite side if odd */}
                    {!isEven && (
                      <div className="hidden md:block absolute top-1/2 -right-36 -translate-y-1/2 space-y-1 font-mono text-xs text-slate-400 text-left">
